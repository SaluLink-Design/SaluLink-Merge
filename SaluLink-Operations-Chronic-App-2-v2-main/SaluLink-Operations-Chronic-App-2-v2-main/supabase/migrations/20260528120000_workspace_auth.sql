-- Workspace, auth profiles, invites, and case scoping for SaluLink MVP
...
-- ---------------------------------------------------------------------------
-- Workspaces (one per doctor practice)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Extend cases for workspace scoping and delivery tracking
-- ---------------------------------------------------------------------------
...
-- Profiles: users read/update own profile; workspace members can read co-member profiles
...
-- Invites: owner creates/reads; invitee can read pending invite by token lookup via RPC
...
-- Cases: workspace-scoped for authenticated users (keep anon policies for legacy dev)
